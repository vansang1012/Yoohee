 ...
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Kind/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_Extension_SendEventNotifications
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/Extension/SendEventNotifications.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Timezone
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/Extension/Timezone.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Link
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/Extension/Link.php';

/**
 * @see Zend_Gdata_Calendar_Extension_QuickAdd
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/Extension/QuickAdd.php';
