 ...
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Calendar/ListEntry.php';
