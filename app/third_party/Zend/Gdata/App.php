 ...
 * Zend_Gdata_Feed
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once APPPATH . '/third_party/'.'Zend/Http/Client.php';
 ...
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once APPPATH . '/third_party/'.'Zend/Http/Client/Exception.php';
        ...
        require_once APPPATH . '/third_party/'.'Zend/Uri/Http.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once APPPATH . '/third_party/'.'Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once APPPATH . '/third_party/'.'Zend/Gdata/HttpAdapterStreamingSocket.php';
