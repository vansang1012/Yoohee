 ...
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Photos/PhotoFeed.php';
