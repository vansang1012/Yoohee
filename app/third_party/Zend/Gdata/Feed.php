 ...
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once APPPATH . '/third_party/'.'Zend/Gdata/Extension/OpenSearchItemsPerPage.php';
