    ...
    <div class="breadcrumb">
        <div class="container">
            <div id="breadcrumbs">
            	...
            	<span class="breadcrumb_last">Cảm nhận người dùng</span>
            </div>
        </div>
    </div>
</section>    
...
<div  class="wrapper-content">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div id="content-page">
                    <div class="entry-title">Cảm nhận người dùng</div>
                    <ul class="list_category">
<?php $list=$this->db->select('*')->from('trainghiem')->where(array('publish'=>1))->order_by('id desc')->get()->result_array();?>
<?php if(isset($list) && count($list)){ foreach($list as $key => $val){ ?>
                                            <li class="rpwe-li rpwe-clearfix">
                            <a href="<?php echo helper_string_alias($val['fullname']).'-t'.$val['id'].CMS_SUFFIX;?>" class="rpwe-img"><img src="<?=$val['image']?>" alt="" class="img-responsive"></a>
                            <h3 class="rpwe-title"><a href="<?php echo helper_string_alias($val['fullname']).'-t'.$val['id'].CMS_SUFFIX;?>" rel="bookmark"><?=$val['fullname']?></a></h3>
                            <?=$val['notes']?>
