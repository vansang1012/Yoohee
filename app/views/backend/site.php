...
<div id="cms-container">
	<div id="cms-filter">
		...
		<div class="right">
			...
			<input type="submit" class="button cms-delete-ajax" value="Xóa DATA" name="craw_item" />
	...
	<div id="cms-table">
		...
		<table cellspacing="0" cellpadding="0" class="data">
			<tr>
				...
				<th>Thao tác</th>
				<th><a class="cms-sort-ajax" href="<?php echo CMS_URL.CMS_BACKEND.'/session/sort/craw_item/highlight'.CMS_SUFFIX;?>">Nổi bật<?php echo cms_common_icon_sort('highlight', $sort);?></a></th>
			...
			<tr <?php echo (($key + 1) == count($full_data))?'class="last"':'';?>>
				...
				<td class="center">
					<a class="cms-set-ajax" href="<?php echo CMS_URL.CMS_BACKEND.'/common/set/craw_item/highlight/'.$val['id'].CMS_SUFFIX;?>">
