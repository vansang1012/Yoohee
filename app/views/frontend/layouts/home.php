...
<body class="home page-template page-template-page-blank page-template-page-blank-php page page-id-97 ot-vertical-menu woocommerce-no-js lightbox lazy-icons nav-dropdown-has-arrow">
